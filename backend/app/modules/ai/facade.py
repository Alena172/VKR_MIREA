...
from app.modules.ai.service.exercises import ExerciseGenerator
...
class AIFacade:
    ...
    Доменные модули (vocabulary, training, review) импортируют только
    ai.facade — никакого прямого обращения к chat_client или провайдеру.
    """
