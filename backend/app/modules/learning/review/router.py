...
from app.modules.learning.review.application_service import context_memory_application_service
...
def _to_review_queue_item_response(item: ReviewQueueItemDTO):
    from app.modules.learning.review.schemas import ReviewQueueItem
...
def _to_review_session_item_response(item: ReviewSessionItemDTO):
    from app.modules.learning.review.schemas import ReviewSessionItem
