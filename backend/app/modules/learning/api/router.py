...
from app.modules.learning.api.exercise_schemas import ExerciseGenerateRequest, ExerciseGenerateRequestMe
...
from app.modules.learning.api.session_schemas import (
    SessionAnswerRead,
...
from app.modules.learning.application.session_submission_service import learning_session_submission_service
...
def _to_review_queue_item_response(item: ReviewQueueItemDTO):
    from app.modules.learning.api.review_schemas import ReviewQueueItem
...
def _to_review_session_item_response(item: ReviewSessionItemDTO):
    from app.modules.learning.api.review_schemas import ReviewSessionItem
