...
from app.modules.learning.session.assembler import to_learning_progress_dto
from app.modules.learning.session.contracts import LearningProgressDTO
from app.modules.learning.session.repository import learning_session_repository
