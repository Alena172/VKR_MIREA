...
from app.modules.ai_services.domain.contracts import ExplainErrorRequest
...
from app.modules.learning.application.session_evaluation import (
    answer_similarity_metrics,
    is_answer_correct,
    is_semantic_override_candidate,
    normalize_answer,
)
from app.modules.learning.domain.session_contracts import (
    SessionAnswerFeedbackDTO,
    SessionSubmitResultDTO,
)
from app.modules.learning.adapters.session_repository import AnswerPersistPayload, learning_session_repository
