...
from app.modules.ai_services.domain.contracts import ExerciseSeed, GenerateExercisesRequest
from app.modules.ai_services.public_api import TranslationProviderUnavailableError, ai_service
from app.modules.learning.domain.exercise_assembler import (
    to_exercise_generate_result_dto,
    to_exercise_item_dto,
)
from app.modules.learning.domain.exercise_contracts import ExerciseGenerateResultDTO, ExerciseItemDTO
from app.modules.learning.application.prefetch_service import prefetch_service
from app.modules.learning.api.exercise_schemas import ExerciseGenerateRequest
