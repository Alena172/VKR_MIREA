...
class UserInterestModel(Base):
    ...
    interest_key: Mapped[str] = mapped_column(
        String(64),
        nullable=False,
        index=True,
    )
...
class WordSenseModel(Base):
    ...
    context_definition_ru: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    )
...
class VocabularySenseLinkModel(Base):
    ...
    word_sense_id: Mapped[int] = mapped_column(
...
class SenseRelationModel(Base):
    ...
    left_sense_id: Mapped[int] = mapped_column(
        ForeignKey("word_senses.id"),
        nullable=False,
        index=True,
    )
    right_sense_id: Mapped[int] = mapped_column(
        ForeignKey("word_senses.id"),
        nullable=False,
        index=True,
    )
...
class SenseErrorEventModel(Base):
    ...
    english_lemma: Mapped[str | None] = mapped_column(
        String(200),
        nullable=True,
        index=True,
    )
    word_sense_id: Mapped[int | None] = mapped_column(
        ForeignKey("word_senses.id"),
        nullable=True,
        index=True,
    )
    mistake_tag: Mapped[str] = mapped_column(
        String(120),
        nullable=False,
        index=True,
    )
