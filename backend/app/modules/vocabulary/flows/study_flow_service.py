...
from app.modules.vocabulary.items.assembler import (
    to_vocabulary_from_capture_result_dto,
    to_vocabulary_item_dto,
)
from app.modules.vocabulary.items.contracts import VocabularyFromCaptureResultDTO, VocabularyItemDTO
from app.modules.vocabulary.items.repository import vocabulary_repository
from app.modules.vocabulary.items.schemas import VocabularyItemCreate
...
vocabulary_study_flow_service = VocabularyStudyFlowService()
