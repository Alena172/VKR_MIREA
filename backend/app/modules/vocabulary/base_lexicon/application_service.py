...
from app.modules.vocabulary.base_lexicon.repository import base_lexicon_repository
from app.modules.vocabulary.base_lexicon.seed_data import load_default_base_lexicon_entries
