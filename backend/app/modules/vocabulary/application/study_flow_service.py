...
from app.modules.ai_services.domain.contracts import TranslateWithContextRequest
...
from app.modules.vocabulary.domain.items_assembler import (
...
from app.modules.vocabulary.api.items_schemas import VocabularyItemCreate
