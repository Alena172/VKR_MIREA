...
from app.modules.vocabulary.domain.translation_assembler import to_translation_result_dto
from app.modules.vocabulary.domain.translation_contracts import TranslationResultDTO
