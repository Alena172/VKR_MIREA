...
from app.modules.vocabulary.adapters.base_lexicon_repository import base_lexicon_repository
from app.modules.vocabulary.domain.base_lexicon_seed_data import load_default_base_lexicon_entries
