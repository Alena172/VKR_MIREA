...
def to_vocabulary_from_capture_result_dto(*, vocabulary: VocabularyItemDTO) -> VocabularyFromCaptureResultDTO:
    return VocabularyFromCaptureResultDTO(vocabulary=vocabulary)


def to_translation_result_dto(*, translated_text: str, note: str) -> TranslationResultDTO:
    return TranslationResultDTO(translated_text=translated_text, note=note)
