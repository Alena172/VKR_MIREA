...
from app.modules.identity.api.auth_schemas import (
...
from app.modules.identity.api.users_schemas import UserCreate, UserRead
from app.modules.identity.application.auth_service import auth_service
