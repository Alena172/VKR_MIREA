...
- предметная логика не размещается в корне такого модуля и живет внутри подмодулей
...
- `learning/review`: практические рекомендации на повторение, такие как due words и recent mistakes
- `learning_graph`: semantic и interest-aware обогащение поверх уже известных слов

Это различие принципиально:

- `learning/review` входит в core learning loop
