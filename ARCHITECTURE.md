# Архитектура ContextVocab

## Обзор системы

ContextVocab - это платформа для изучения английского языка русскоязычными пользователями через реальный контекст, короткие упражнения и интервальные повторения.
